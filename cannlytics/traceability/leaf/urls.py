...
LEAF_DISPOSAL_URL = LEAF_API_BASE_URL + '/disposal'
LEAF_DISPOSAL_UPDATE_URL = LEAF_API_BASE_URL + '/disposal/update'
LEAF_DISPOSAL_DELETE_URL = LEAF_API_BASE_URL + '/disposal/%s'
LEAF_DISPOSAL_DISPOSE_URL = LEAF_API_BASE_URL + '/disposal/dispose'
